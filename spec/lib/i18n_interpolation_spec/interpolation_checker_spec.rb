...
describe I18nInterpolationSpec::InterpolationChecker do
  ...
  describe '::extract_interpolation_keys' do
    ...
    it 'should extract interpolation keys' do
      ...
      expect(I18nInterpolationSpec::InterpolationChecker.extract_interpolation_keys(text)).to eq keys
    end
    ...
    it 'should not extract keys of interpolation-like syntax with escaped %' do
      ...
      expect(I18nInterpolationSpec::InterpolationChecker.extract_interpolation_keys(text)).not_to include non_key
    end
  ...
  describe '::list_interpolation_keys' do
    ...
    it 'should return pairs of scope and interpolation keys' do
      ...
      expect(I18nInterpolationSpec::InterpolationChecker.list_interpolation_keys(translations)).to eq keys
    end
  ...
  describe '::check' do
    ...
    it 'should return an empty hash if interpolation keys are fully contained in both key lists' do
      ...
      expect(I18nInterpolationSpec::InterpolationChecker.check(t1, t2)).to eq({})
    end
    ...
    it 'should return a hash of missing translations keys if interpolation keys are not fully contained in both key lists' do
      ...
      expect(I18nInterpolationSpec::InterpolationChecker.check(t1, t2)).to eq keys
    end
